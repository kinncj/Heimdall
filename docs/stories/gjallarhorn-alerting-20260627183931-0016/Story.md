---
id: "gjallarhorn-alerting-0016"
title: "Gjallarhorn: Alerting and Notifications"
epic: "gjallarhorn-alerting"
priority: "high"
ui: false
adr_required: true
milestone: "v1.2.0"
...
# Gjallarhorn: Alerting and Notifications

## Story

As an operator,
I want threshold alerts and notifications,
so that I'm told when something is wrong instead of having to watch.
